...
function get20s(arr){
  ...
  for(let i=0; i < arr.length; i++) {
    if(artists[i].years.split(" ")[0] > 1899 && artists[i].years.split(" ")[2] < 2000) {
...
let me = {
  ...
  bio: `You know what can't fit in a bottle are the twenty little trips I take to the cooler. And the twenty little scans I do of everybody to make sure everything's running smoothy and the twenty conversations that I have with Stanley.`
}
